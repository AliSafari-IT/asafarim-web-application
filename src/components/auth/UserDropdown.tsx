            ...
            {user.role === 'Admin' && (
              <>
                ...
                <div className="dropdown-section admin-section">
                  ...
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12,2A12,12 0 0,0 0,14A12,12 0 0,0 12,26A12,12 0 0,0 24,14A12,12 0 0,0 12,2M7,7H17A1,1 0 0,1 18,8V16A1,1 0 0,1 17,17H7A1,1 0 0,1 6,16V8A1,1 0 0,1 7,7M8,9V15H16V9H8Z"/>
                    </svg>
                    Manage Repositories
                  </Link>
